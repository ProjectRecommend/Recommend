...
class Ui_EditMetaDataDialog(object):
    def setupUi(self, EditMetaDataDialog):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icons/ic_cancel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/ic_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addLayout(self.formLayout, 1, 0, 1, 6)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem2, 2, 5, 1, 1)
        self.label = QtWidgets.QLabel(EditMetaDataDialog)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, EditMetaDataDialog):
        ...
        self.label.setText(_translate("EditMetaDataDialog", "You can Use  MusicBrainz Picard (https://picard.musicbrainz.org/) to tag and update metadata of multiple songs"))
