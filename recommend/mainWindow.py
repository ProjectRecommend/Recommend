...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Lists.addWidget(self.RecommendLocal, 1, 1, 1, 1)
        self.Playlist = QtWidgets.QTableView(self.centralwidget)
        self.Playlist.setObjectName("Playlist")
        self.Lists.addWidget(self.Playlist, 1, 0, 2, 1)
        ...
        self.Lists.addWidget(self.label, 0, 0, 1, 1)
        ...
        self.Lists.addWidget(self.label_2, 0, 1, 1, 1)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Your Playlist"))
